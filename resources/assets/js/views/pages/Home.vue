<template>
<div>
  <!-- <v-app-bar app color="secondary"> </v-app-bar> -->
    ...
    <div class="mx-4 overflow-hidden card card-body blur shadow-blur mt-n6">
      <div class="row gx-4">
        ...
        <div class="col-auto my-auto">
          <div class="h-100">
            <h5 class="mb-1" style="text-transform: uppercase;">{{ userDetails.first_name }} {{ userDetails.last_name }}</h5>
            <p class="mb-0 text-sm font-weight-bold" style="text-transform: capitalize;">{{ userDetails.role }}</p>
          </div>
        </div>
        <div
  ...
  <div class="py-4 container-fluid">
    <div class="mt-3 row">
      <div class="mt-4 col-12 col-md-6 col-xl-4 mt-md-0">
          <div class="card h-100">
            ...
            <div class="p-3 card-body">
              ...
              <ul class="list-group">
                <li class="pt-0 text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Full Name:</strong> &nbsp; {{userDetails.first_name}} {{userDetails.last_name}}
                </li>
                <li class="text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Mobile:</strong> &nbsp; {{userDetails.phone}}
                </li>
                <li class="text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Email:</strong> &nbsp; {{userDetails.email}}
                </li>
                <li class="text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Gender:</strong> &nbsp; {{userDetails.gender}}
                </li>
                <li class="text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Role:</strong> &nbsp; {{userDetails.role}}
                </li>
                <li class="text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Allocated polling:</strong> &nbsp; {{userDetails.allocated_area}}
                </li>
                <li class="text-sm border-0 list-group-item ps-0" style="text-transform: capitalize;">
                  <strong class="text-dark">Joined:</strong> &nbsp; {{userDetails.created_at}}
                </li>
      ...
      <div class="mt-4 col-12 col-xl-4 mt-xl-0">
        <div class="card h-100">
          <div class="p-3 pb-0 card-header">
            <h6 class="mb-0">Electoral areas</h6>
          </div>
          <div class="p-3 card-body">
            <ul class="list-group">
              <li
              ...
              >
                ...
                >
                  <h6 class="mb-0 text-sm">Republic fo Kenya</h6>
                  <p class="mb-0 text-xs">The president</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
              ...
              >
                ...
                <div
                  class="d-flex align-items-start flex-column justify-content-center"
                >
                  <h6 class="mb-0 text-sm">County</h6>
                  <p class="mb-0 text-xs">Governor,Senator,Woman Rep of ntl assembly</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
              ...
              >
                <div
                  class="d-flex align-items-start flex-column justify-content-center"
                >
                  <h6 class="mb-0 text-sm">Constituency</h6>
                  <p class="mb-0 text-xs">Member of national assembly</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
              ...
              >
                <div
                  class="d-flex align-items-start flex-column justify-content-center"
                >
                  <h6 class="mb-0 text-sm">Ward</h6>
                  <p class="mb-0 text-xs">Member of county assembly</p>
                </div>
                <a
                  class="mb-0 btn btn-link pe-3 ps-0 ms-auto"
                  href="javascript:;"
...
export default {
  ...
  methods: {
    ...
    getPollingByName (){
      axios.get('/api/v1/polling/' + this.userDetails.allocated_area)
        .then(response => {
            console.log(response)
        })
        .catch(response => {
