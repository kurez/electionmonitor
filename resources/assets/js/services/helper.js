export default {
    logout(){
        return axios.post('/electionmonitorapi/v1/auth/logout').then(response =>  {
    ...
    authUser(){
        return axios.get('/electionmonitorapi/v1/auth/user').then(response =>  {
    ...
    check(){
        return axios.post('/electionmonitorapi/v1/auth/check').then(response =>  {
