export default {
    logout(){
        return axios.post('/electionmonitor/api/v1/auth/logout').then(response =>  {
    ...
    authUser(){
        return axios.get('/electionmonitor/api/v1/auth/user').then(response =>  {
    ...
    check(){
        return axios.post('/electionmonitor/api/v1/auth/check').then(response =>  {
