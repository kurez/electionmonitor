export default {
    logout(){
        return axios.post('/electionmanager/api/v1/auth/logout').then(response =>  {
    ...
    authUser(){
        return axios.get('/electionmanager/api/v1/auth/user').then(response =>  {
    ...
    check(){
        return axios.post('/electionmanager/api/v1/auth/check').then(response =>  {
